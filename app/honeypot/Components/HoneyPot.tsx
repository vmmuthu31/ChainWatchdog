                  ...
                  <div className="p-4 sm:p-5 bg-[#ffaa00]/10 rounded-xl border border-[#ffaa00]/30 mt-5">
                    <div className="flex gap-4 items-start">
                      ...
                      >
                        ...
                        only. Always do your own research (DYOR) before
                        investing. RugProof is not responsible for any trading
                  ...
                  {!contractResult?.fullCheckPerformed && (
                    <div className="p-3 sm:p-4 bg-[#ffaa00]/10 rounded-xl border border-[#ffaa00]/30">
                      <div className="flex gap-3 items-start">
                        ...
                        >
                          Full check could not be performed. This happens when
                          the simulation fails to get a complete call tree. Some
                    ...
                    <div className="p-3 sm:p-4 bg-[#ffaa00]/10 rounded-xl border border-[#ffaa00]/30">
                      <div className="flex gap-3 items-start">
                        ...
                        <p
                          className={`${pixelMonoFont.className} text-sm sm:text-base text-[#ffaa00]`}
                        >
                          The endpoint is currently limited to returning up to
                          10 pairs with the highest liquidity.
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <tbody>
                          {holdersResult.holders.map((holder, index) => {
                            ...
                            const totalSupply = BigInt(
                              holdersResult.totalSupply
                            );
                            const percentage =
                              totalSupply > 0
                                ? Number(
                                    (holderBalance * BigInt(10000)) /
                                      totalSupply
                                  ) / 100
                                : 0;
